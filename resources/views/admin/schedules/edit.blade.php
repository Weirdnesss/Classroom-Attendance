...
<div class="mb-6">
    ...
    <h1 class="text-xl font-semibold mt-1">Edit Schedule</h1>
</div>
            ...
            <select name="academic_term_id"
                ...
                @foreach($terms as $term)
                    <option value="{{ $term->id }}"
                        {{ old('academic_term_id', $schedule->academic_term_id) == $term->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                <select name="year_level"
                    ...
                    @foreach(range(1, 6) as $y)
                        <option value="{{ $y }}"
                            {{ old('year_level', $schedule->year_level) == $y ? 'selected' : '' }}>
                            Year {{ $y }}
                        </option>
                    @endforeach
                </select>
