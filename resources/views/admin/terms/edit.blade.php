...
<div class="mb-6">
    ...
    <h1 class="text-xl font-semibold mt-1">Edit Term</h1>
</div>
...
<div class="bg-white border border-gray-200 rounded p-6 max-w-lg">
    <form method="POST" action="{{ route('admin.terms.update', $term) }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="label" value="{{ old('label', $term->label) }}"
                   class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-gray-400">
        ...
        <div class="mb-6 flex items-center gap-2">
            ...
            <label for="is_active" class="text-sm">Set as active term</label>
        </div>
